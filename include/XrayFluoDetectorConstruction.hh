...
private:
  ...
  G4Tubs*             solidCulayer;    //pointer to the solid Culayer
  G4LogicalVolume*   logicCulayer;    //pointer to the logical Culayer
  G4VPhysicalVolume* physiCulayer;    //pointer to the physical Culayer
  G4Tubs*             solidAblator;    //pointer to the solid Ablator
  G4LogicalVolume*   logicAblator;    //pointer to the logical Ablator
  G4VPhysicalVolume* physiAblator;    //pointer to the physical Ablator
  G4Tubs*             solidAllayer;    //pointer to the solid Allayer
  ...
  G4Box*             solidBMXS;
  G4LogicalVolume*   logicBMXS;
  G4VPhysicalVolume* physiBMXS;

  G4VPhysicalVolume* physiBMXS55;

  G4Tubs*            solidBMXSCollimator;
  G4LogicalVolume*   logicBMXSCollimator;
  G4VPhysicalVolume* physiBMXSCollimator;

  G4Box*            solidTeflonBlock;
  G4LogicalVolume*   logicTeflonBlock;
  G4VPhysicalVolume* physiTeflonBlock;

  G4Box*             solidCartridge;
  G4LogicalVolume*   logicCartridge;
  G4VPhysicalVolume* physiCartridge;



  ///need to declare filters and IPs, later
  ///
