...
void XrayFluoNistMaterials::CreateMaterials()
{
  ...
  // Materials Definitions
    ...
    G4Material* madaBasaltMain= nistMan->ConstructNewMaterial("MixCuCH",elements, fractionMass, density);
    elements.clear();
    fractionMass.clear();
    ...
    G4Material* madaBasaltMain= nistMan->ConstructNewMaterial("CuFoam",elements, fractionMass, density);
    elements.clear();
    fractionMass.clear();
