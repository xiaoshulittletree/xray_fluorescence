...
void XrayFluoNistMaterials::CreateMaterials()
{
  ...
  // Define Phosphorescence  0054.PP.0044 sample
  density = 2.85*g/cm3;
  elements.push_back("Ba");  natoms.push_back(100);  // 0.007093 mol/g(mat)
  elements.push_back("F");  natoms.push_back(100); // 4.235e-4
  elements.push_back("Br");  natoms.push_back(85); // 0.001763
  elements.push_back("I");  natoms.push_back(15);  // 0.002333
  elements.push_back("Eu");  natoms.push_back(100);// 2.820e-5




  G4Material* Phosphorescence= nistMan->ConstructNewMaterial("Phosphorescence",elements, natoms, density);
  elements.clear();
  natoms.clear();
  ...
  // Define SupportPlastic  0054.PP.0044 sample
  density = 1.66*g/cm3;
  elements.push_back("C");  natoms.push_back(2);  // 0.007093 mol/g(mat)
  elements.push_back("H");  natoms.push_back(2); // 4.235e-4
  elements.push_back("O");  natoms.push_back(1); // 0.001763

  G4Material* SupportPlastic= nistMan->ConstructNewMaterial("SupportPlastic",elements, natoms, density);
  elements.clear();
  natoms.clear();
    ...
    density = 2.77*g/cm3;
    elements.push_back("Zn");  natoms.push_back(1);  // 0.007093 mol/g(mat)
    elements.push_back("Mn");  natoms.push_back(2); // 4.235e-4
    elements.push_back("Fe");  natoms.push_back(5); // 0.001763
    elements.push_back("N");  natoms.push_back(1);  // 0.002333
    elements.push_back("O");  natoms.push_back(40);// 2.820e-5
    elements.push_back("H");  natoms.push_back(15); // 0.003350
    elements.push_back("C");  natoms.push_back(10); // 0.001614


     // sum is 0.04434383 total number of moles of atoms in one gram of material
    // 2.248766e8 g per 10.000.000 moles.

    G4Material* Magnet= nistMan->ConstructNewMaterial("Magnet",elements, natoms, density);
    elements.clear();
    natoms.clear();
  ///////////////////////
  // Madagascar Basalt //
