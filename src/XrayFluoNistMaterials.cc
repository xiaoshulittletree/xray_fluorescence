...
void XrayFluoNistMaterials::CreateMaterials()
{
  ...
  // Define CHfoamCl
  density = 0.1*g/cm3;
  elements.push_back("C");  fractionMass.push_back(0.9138);  // 0.007093 mol/g(mat)
  elements.push_back("H");  fractionMass.push_back(0.0762); // 4.235e-4
  elements.push_back("Cl");  fractionMass.push_back(0.01); // 0.001763



  G4Material* CHfoamCl= nistMan->ConstructNewMaterial("CHfoamCl",elements, fractionMass, density);
  elements.clear();
  fractionMass.clear();
